...
const KEYFRAMES = [
    { hour: 0,
        ambient: [0x0a0a1a, 0.08],
        sun: [0x224488, 0.02],
        hemi: [0x0a0a2a, 0x050510, 0.1],
        fill: [0x0a0a30, 0.05, 60],
        rim: [0x0a0a30, 0.05, 40, 30, 40],
        fog: 0x0a0a1a,
        sky: ['#050510','#0a0a20','#151530','#0a0a1a','#0a0a1a'] },
    { hour: 5,
        ambient: [0x202040, 0.15],
        sun: [0x8866aa, 0.15],
        hemi: [0x303060, 0x1a1030, 0.25],
        fill: [0x604080, 0.15, 60],
        rim: [0x604080, 0.10, 40, 40, 40],
        fog: 0x202040,
        sky: ['#0a0a20','#1a1030','#302050','#403060','#303050'] },
    { hour: 7,
    ...
    { hour: 19,
        ambient: [0x502020, 0.25],
        sun: [0xff5522, 0.60],
        hemi: [0xcc6644, 0x2a1010, 0.35],
        fill: [0xff6622, 0.25, 60],
        rim: [0xff4411, 0.10, 40, 30, 40],
        fog: 0x884433,
        sky: ['#2a0a20','#5a2020','#994433','#cc7744','#dd8855'] },
    { hour: 22,
        ambient: [0x101020, 0.10],
        sun: [0x335588, 0.05],
        hemi: [0x101030, 0x080810, 0.12],
        fill: [0x101040, 0.06, 60],
        rim: [0x101040, 0.04, 40, 30, 40],
        fog: 0x101020,
        sky: ['#050510','#0a0818','#151030','#201840','#181830'] },
];
